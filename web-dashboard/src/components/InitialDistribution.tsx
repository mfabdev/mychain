...
export const InitialDistribution: React.FC = () => {
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-6">
      <h2 className="text-xl font-bold mb-4">Current ALC Distribution</h2>
      ...
      <div className="mb-6">
        <div className="relative h-12 bg-gray-700 rounded-lg overflow-hidden">
          ...
          >
            <span className="text-sm">Staked: {distribution.stakedAmount.toLocaleString()} ALC</span>
          </div>
          <div 
          ...
          >
            <span className="text-sm">Unstaked: {distribution.unstakedAmount.toLocaleString()} ALC</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-gray-700/50 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-blue-400">{distribution.totalSupply.toFixed(2)} ALC</p>
        ...
        <div className="bg-purple-900/30 border border-purple-500/30 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-purple-300">{distribution.stakedAmount.toLocaleString()} ALC</p>
        ...
        <div className="bg-green-900/30 border border-green-500/30 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-green-300">{distribution.unstakedAmount.toFixed(2)} ALC</p>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-gray-600/30 rounded">
            ...
            <div className="text-right">
              <p className="text-xl font-bold text-purple-400">{distribution.stakedAmount.toLocaleString()} ALC</p>
          ...
          <div className="flex items-center justify-between p-3 bg-gray-600/30 rounded">
            ...
            <div className="text-right">
              <p className="text-xl font-bold">{distribution.unstakedAmount.toLocaleString()} ALC</p>
          ...
          <div className="space-y-2">
            {distribution.validators.map((val) => (
              <div key={val.address} className="flex justify-between items-center p-2 bg-gray-600/30 rounded">
                ...
                <div className="text-right">
                  <p className="font-semibold">{val.stakedAmount.toLocaleString()} ALC</p>
      ...
      <div className="mt-4 p-3 bg-blue-900/30 border border-blue-500/30 rounded-lg">
        <p className="text-sm text-blue-400">
          <strong>Note:</strong> The blockchain was intended to have 90,000 ALC staked at genesis, but currently 
          only {distribution.stakedAmount.toLocaleString()} ALC is staked. You can use the Staking Manager above to stake 
          your ALC tokens with validators to earn 10% APR rewards and help secure the network.
        </p>
      </div>
    </div>
  );
