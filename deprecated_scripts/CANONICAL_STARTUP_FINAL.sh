...
# ==============================================================================
# CANONICAL MyChain Blockchain Startup Script - FINAL VERSION
# ==============================================================================
...
# 
# Initial State:
# - 1 TUSD in reserve (which creates the 100,000 MC supply)
# - Dev allocation (10 MC) created during segment 0→1 transition
# - SDK Minting starts at 100% inflation
# ==============================================================================
...
$BINARY genesis add-genesis-account $ADMIN_ADDR "100000000000ulc,100000000000utusd,100000000000umc"
...
genesis['app_state']['mint']['params'] = {
    'mint_denom': 'ulc',  # Bond denom is LC (ulc)
...
# Configure Staking - Bond denom is LC (ulc)
...
genesis['app_state']['staking']['params']['max_entries'] = 7
genesis['app_state']['staking']['params']['historical_entries'] = 10000
genesis['app_state']['staking']['params']['min_commission_rate'] = '0.000000000000000000'

# Configure Governance - Use LC (ulc) for deposits
...
genesis['app_state']['gov']['params']['max_deposit_period'] = '172800s'
genesis['app_state']['gov']['params']['voting_period'] = '172800s'

# Configure Crisis - Use LC (ulc)
...
genesis['app_state']['maincoin'] = {
    'params': {
        ...
        'dev_allocation_percentage': '0.0001',  # 0.01%
        'reserve_ratio': '0.1'
    },
    'maincoin_state': {
        'current_segment': '0',
        ...
        'developer_allocation': '0',        # 0 initially (10 MC created during segment 0→1)
...
print("  • Chain ID: mychain")
print("  • Bond denom: ulc (LC)")
print("  • SDK Minting: 100% initial inflation (7-100% range)")
print("  • MainCoin: 100,000 MC with 1 TUSD reserve")
print("  • Dev allocation: 0 MC (10 MC created during segment 0→1)")
EOF
...
print_success "Created validator with 90,000 LC stake"
...
echo "  • LiquidityCoin:   100,000 LC (90,000 staked to validator)"
echo "  • MainCoin:        100,000 MC (created by 1 TUSD reserve)"
echo "  • TestUSD:         100,000 TUSD"
echo
echo "SDK Minting Configuration:"
echo "  • Initial Rate:    100% APR"
echo "  • Goal Bonded:     50%"
echo "  • Inflation Range: 7% - 100%"
echo "  • Bond Denom:      LC (ulc)"
echo
echo "MainCoin Initial State:"
echo "  • Segment:         0"
echo "  • Price:           \$0.0001 per MC"
echo "  • Reserve:         1 TUSD"
echo "  • Dev Allocation:  0 MC (10 MC created at segment 0→1)"
echo
...
echo
echo "Next Steps:"
echo "  1. Monitor logs:     tail -f $HOME/mychain.log"
echo "  2. Check status:     curl http://localhost:26657/status"
echo "  3. Check supply:     curl http://localhost:1317/cosmos/bank/v1beta1/supply"
echo "  4. Start dashboard:  cd web-dashboard && npm start"
echo
echo "=============================================="